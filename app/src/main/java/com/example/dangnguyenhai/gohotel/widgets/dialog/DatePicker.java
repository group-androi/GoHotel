...
import com.example.dangnguyenhai.gohotel.utils.ArraysUtils;
...
public class DatePicker extends FrameLayout {
    ...
    public DatePicker(Context context) {
        ...
        DEFAULT_END_YEAR = newDate.get(Calendar.YEAR) - 18;
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        NumberPicker.OnValueChangeListener onChangeListener = (picker, oldVal, newVal) -> {
            updateInputState();
    ...
    private Calendar getCalendarForLocale(Calendar oldCalendar, Locale locale) {
        if (oldCalendar == null) {
            ...
            int year = newCalendar.get(Calendar.YEAR) - 18;
